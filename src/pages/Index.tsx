...
/**
 * Index component - Main page of the application
 * This component is imported in App.tsx and renders the main application UI
 * Uses hooks from context and components for audio playback, file upload and search
 */
const Index = () => {
